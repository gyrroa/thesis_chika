...
export default function Home() {
  ...
  return (
    <main className="flex items-center justify-center justify-items-center min-h-screen font-[family-name:var(--font-sans)] bg-[#F2E7DC] bg-[url('/background.svg')] bg-cover bg-no-repeat">
