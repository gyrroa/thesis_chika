...
export default function Home() {
    ...
    return (
        <div className="items-center justify-items-center min-h-screen font-[family-name:var(--font-sans)] bg-[#F2E7DC] bg-[url('/background.svg')] bg-cover bg-no-repeat">
            <Header />
            <main className="flex flex-col items-center text-center justify-center h-screen select-none pt-[60px] md:pt-[120px]">
                {step === 'userType' && (
                    <>
                        <div className='bg-[#FFFDF2] w-screen h-screen rounded-t-[45px] text-[#C45500] [box-shadow:0px_-1px_24.1px_0px_rgba(196,85,0,0.30)]'>
                            <form onSubmit={handleSubmit} className="text-[16px] max-w-[311px] mx-auto space-y-4 pt-[50px] pb-[5px]">
                                ...
                                <div className='flex gap-[19px] items-center justify-center'>
                                    <div className="w-14 h-14 rounded-full border border-[#C45500] items-center flex p-[15px] cursor-pointer">
                                        <Image
                                ...
                                <h1>Already have an account? <span className='font-bold text-[#FF9900] underline cursor-pointer'>Log in</span></h1>
                            </form>
                        </div>
                    </>
                )}
